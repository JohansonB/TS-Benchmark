...
std::tuple<arma::mat, arma::mat, arma::mat> return_model(arma::mat& data, trmf_param_t& param, arma::uvec lagset, size_t rank)
{
   ...
   return std::make_tuple(W.t(), lag_val.t(), H.t());
}
